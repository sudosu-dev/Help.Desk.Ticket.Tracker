...
-- =============================================================================
INSERT INTO tickets (
    requester_user_id, assignee_user_id, description, 
...
INSERT INTO ticket_attachments (
    ticket_id, file_url, file_name, file_type, file_size, uploaded_at
) VALUES
(
    -- Attachment for Ticket 1: "Cannot access shared drive"
    1, -- Assuming this is the ticket_id for John's "Cannot access shared drive" ticket
    '/uploads/seed_data/ticket_1/access_denied_M_drive.jpg', -- Placeholder path
...
(
    -- Attachment for Ticket 2: "Email not sending - CRITICAL..."
    2, -- Assuming this is the ticket_id for Alice's "Email not sending" ticket
    '/uploads/seed_data/ticket_2/outlook_error_screenshot.png', -- Placeholder path
...
(
    -- Attachment for Ticket 4: "Request for new software license..."
    4, -- Assuming this is the ticket_id for Adeline's "Request for new software license" ticket
    '/uploads/seed_data/ticket_4/Department_Approval_DesignProX.pdf', -- Placeholder path
